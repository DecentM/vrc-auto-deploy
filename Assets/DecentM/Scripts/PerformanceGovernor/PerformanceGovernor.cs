...
public class PerformanceGovernor : UdonSharpBehaviour
{
    ...
    private void FixedUpdate()
    {
        ...
        if (this.fixedClock % (this.updateRate * CheckEverySeconds) == 0)
        {
            this.CheckFrames();
            this.fixedClock = 0;
            this.lastFpsMeasured = this.fpsAverage;
            this.fpsAverage = 0;
        }
    ...
    {
        // Check the current framerate and increase or decrease the level based on the current FPS + some headroom
